...
// 기본값, 또는 고정 값 설정
// 속성 기술자 옵션 설정을 이용해 속정의 기본 값을 지정하거나, 변경할 수 없는 읽기 전용 고정 속성 값을 지정할 수 있다.
// value, writable 2개의 옵션으로 기본 값, 또는 고정값 설정을 할 수 있다.
// get, set 과는 함께 사용할 수 없으므로 주의해야 함.



// 기본값, 또는 고정 값 설정
// 속성 기술자 옵션 설정을 이용해 속성의 기본 값을 지정하거나, 변경할 수 없는 읽기 전용 ㅗ정 속성값을 지정할수있다.
// value, writable 2개의 옵션으로 기본 값, 또는 고정값 설정을 할 수 있다.
